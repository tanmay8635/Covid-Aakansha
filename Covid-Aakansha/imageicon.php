...
<button type="button" class="btn btn-primary" aria-hidden="true" data-toggle="modal" data-target="#myModal1">

          <span class="glyphicon glyphicon-hand-left"></span> Offer
        </button>
        <!-- The Modal -->
  ...
  <div class="form-group">
   ...
   <input type="text"  name="mobile_num" value="<?php echo $nm1?>" readonly>
